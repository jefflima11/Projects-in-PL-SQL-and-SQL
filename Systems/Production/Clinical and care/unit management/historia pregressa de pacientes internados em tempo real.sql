...
SELECT DESCRICAO,
			 ...
			 DS_UNID_INT,
			 DS_LEITO,
			 Decode(CELULAR_C, '()', 'NAO INFORMADO', CELULAR_C) NR_CELULAR,
			 Decode(FONE_C, '()', 'NAO INFORMADO', FONE_C) NR_FONE

	FROM ( --CASE DE FILTRAGEM APENAS "SIM"
				SELECT ERC.CD_REGISTRO,
								ERC.CD_CAMPO,
								Decode(EC.DS_IDENTIFICADOR,
											 'osm_radio_31',
											 'HIPERTENSAO',
											 'osm_radio_32',
											 'DIABETES',
					...
					FROM DBAMV.EDITOR_REGISTRO_CAMPO ERC,
								...
								(
								 ...
								 SELECT *
									 ...
									 FROM --SUB-SELECT DE APONTAMENTO DE DIRECIONAMENTO
													(SELECT PDC2.CD_DOCUMENTO_CLINICO,
														 ...
														 FROM DBAMV.PW_DOCUMENTO_CLINICO PDC2,
																	DBAMV.PW_EDITOR_CLINICO    PEC2
													 
														WHERE PDC2.CD_DOCUMENTO_CLINICO =
																	PEC2.CD_DOCUMENTO_CLINICO

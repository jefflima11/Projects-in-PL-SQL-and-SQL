...
DATA DE DESENVOLVIMENTO: 13/10/2023
ATUALIZADO: 30/10/2023
TITULO: PACIENTES COM RETORNO DE 30 DIAS PA
DESCRICAO: PACIENTES QUE TIVERAM RETORNO DENTRO 30 DIAS NO PRONTO ATENDIMENTO ADULTO
FILTROS:
   - TIPO DE ATENDIMENTO = URGENCIA E EMERGENCIA
   - CONVÉNIO = 3(UNIMED IMPERATRIZ)
   - EMPRESA = HOSPITAL UNIMED IMPERATRIZ
   - ORIGEM DO ATENDIMENTO = 14(PRONTO SOCORRO ADULTO)
   - DATA = 01/09/2022 A 31/09/2023
*/

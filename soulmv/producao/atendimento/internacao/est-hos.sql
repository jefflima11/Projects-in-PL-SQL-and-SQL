        ...
        ROUND(((((SUM(PAC_INT_00H)+SUM(ENT_INTERNADOS)+SUM(ENT_TRANSF))-(SUM(SAI_ALTAS)+SUM(SAI_TRANSFPARA)+SUM(SAI_OBITOS)))*100)/(/*Leitos por dia no periodo*/
                                                                                                                                    SELECT  COUNT (*) TOTALLEITO
                                                                                                                                      ...
                                                                                                                                      FROM DBAMV.LEITO,
                                                                                                                                           ...
                                                                                                                                           DBAMV.SETOR,
                                                                                                                                           DBAMV.TIP_ACOM,
                                                                                                                                           (SELECT (TO_DATE('29/04/2024', 'dd/mm/yyyy') - 1) + ROWNUM DATA
                                                                                                                                              FROM DBAMV.CID
                                                                                                                                             WHERE (TO_DATE('29/04/2024', 'dd/mm/yyyy') - 1) + ROWNUM <=                                               TO_DATE('29/04/2024', 'dd/mm/yyyy')) CONTADOR
...
FROM    DBAMV.MOV_INT,
        ...
        ( SELECT( TO_DATE('29/04/2024', 'dd/mm/yyyy') - 1  + ROWNUM )DATA
          FROM DBAMV.CID
          WHERE TO_DATE('29/04/2024', 'dd/mm/yyyy') - 1  + ROWNUM <= TO_DATE('29/04/2024', 'dd/mm/yyyy')
        ) CONTADOR

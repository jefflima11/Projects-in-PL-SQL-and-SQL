...
DATA: 17/11/2023
TITULO: MOVIMENTAÇÕES DE CARDAPIO PARA PACIENTE
DESCRICAO: MOVIMENTAÇÕES DE CARDAPIO PARA FUNCIONARIOS POR SETOR, POR TIPO DE REFEIÇÕES E POR DIA.
FILTROS:
...
FROM(   SELECT  S.NM_SETOR,
        ...
        WHERE   MC.CD_SETOR = S.CD_SETOR
          ...
          --AND   S.CD_SETOR IN (37)
          --AND   OC.CD_OPCAO IN  (165)  
